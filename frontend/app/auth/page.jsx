...
export default function AuthPage() {
  ...
  return (
    <div className="
      ...
      p-[10px] sm:p-6 md:p-8   /* MOBILE SMALLER */
    ">
      ...
      <div className="flex flex-col w-full max-w-sm md:max-w-lg z-10">
        <div className="flex flex-col gap-6 sm:gap-8">
          ...
          <div className="flex flex-col gap-2 sm:gap-3">
            <div className="
              text-[#4A4D6B] 
              text-3xl sm:text-6xl   /* MOBILE SMALLER, DESKTOP SAME */
              font-black
            ">
              DejaView
            </div>
            ...
            <p className="
              text-[#4A4D6B] 
              text-base sm:text-2xl   /* MOBILE SMALLER */
              font-normal
            ">
          ...
          <div className="flex w-full bg-gray-100 p-[4px] sm:p-1 rounded-lg">
            <button
              ...
              className={`
                w-1/2 
                py-[6px] sm:py-2    /* MOBILE SMALLER */
                rounded-md 
                text-sm sm:text-lg  /* MOBILE SMALLER */
                font-bold
                ${mode === 'login'
          ...
          <form className="flex flex-col gap-3 sm:gap-4">
            ...
            {mode === 'signup' && (
              <label className="flex flex-col w-full">
                <p className="text-[#4A4D6B] text-sm sm:text-base pb-1">
                  Name
                </p>
                <input
                  className="
            ...
            <label className="flex flex-col w-full">
              <div className="flex justify-between pb-1">
                <p className="text-[#4A4D6B] text-sm sm:text-base">
                  Password
                </p>

                {mode === 'login' && (
                  <Link className="text-[#7E95F7] text-xs sm:text-sm" href="/forgot-password">
                    Forgot Password?
                  </Link>
                )}
              </div>
